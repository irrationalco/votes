...
ine_select[is.na(ine_select)] <- -1

# Se llaman diferentes porque y final es numeric y subsetado por el código final
...
# Por ahora, dejamos como base al PRI
respuestas <- relevel(respuestas, "PRI")
# levels(y)
