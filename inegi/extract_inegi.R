...
write.csv(key, './out/inegi_vs_ife_key.csv', row.names = FALSE, quote = FALSE)
...
write.csv(map_sample, './out/map_sample.csv', row.names = FALSE, quote = FALSE)
...
write.csv(inegi.key, './out/inegi.csv', row.names = FALSE, quote = FALSE)